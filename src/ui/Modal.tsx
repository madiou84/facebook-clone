    ...
    <Transition appear show={isOpen} as={Fragment}>
      ...
      >
        <div className="min-h-screen px-4 text-center">
          ...
          >
            <Dialog.Overlay className="fixed inset-0 bg-gray-800 dark:bg-gray-100 bg-opacity-80 dark:bg-opacity-80" />
          </Transition.Child>
            ...
            <div className="inline-block w-full max-w-lg py-2 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-2xl rounded-xl">
              ...
              <div className="mt-4 px-4 py-2">
                <button
                  type="button"
                  onClick={onClickClose}
                  className="w-full inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-defaultcolor-500 border border-transparent rounded-md hover:bg-blue-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500"
                >
                  Publier
                </button>
              </div>
